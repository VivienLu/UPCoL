...
if __name__ == '__main__':
    ...
    labset = Pancreas(data_dir, list_dir,split='lab')
    unlabset = Pancreas(data_dir,list_dir,split='unlab')
    trainset = Pancreas(data_dir,list_dir,split='train')
    testset = Pancreas(data_dir, list_dir,split='test')
    ...
    labset = Pancreas(data_dir, list_dir,split='lab', aug_times=5)
    unlabset = Pancreas(data_dir,list_dir,split='unlab', aug_times=5)
    trainset = Pancreas(data_dir,list_dir,split='train', aug_times=5)
    testset = Pancreas(data_dir, list_dir,split='test', aug_times=5)
